...
fn constructor() {
    ...
    let gauge_controller: Key = runtime::get_named_arg("gauge_controller");

    mappings::set_key(&mappings::self_hash_key(), contract_hash);
    mappings::set_key(&mappings::self_package_key(), package_hash);
    mappings::set_key(
        &mappings::gauge_controller_key(),
        ContractHash::from(gauge_controller.into_hash().unwrap_or_default()),
    );
}
...
fn transfer() {
    ...
    let ret: Result<(), u32> = runtime::call_contract(gauge_controller_address, "transfer", args);
...
fn approve() {
    ...
    let _ret: () = runtime::call_contract(gauge_controller_address, "approve", args);
}
...
fn allowance() {
    ...
    let ret: U256 = runtime::call_contract(gauge_controller_address, "allowance", args);
...
fn get_entry_points() -> EntryPoints {
    ...
    entry_points.add_entry_point(EntryPoint::new(
        ...
        vec![
            ...
            Parameter::new("gauge_controller", Key::cl_type()),
        ],
        <()>::cl_type(),
