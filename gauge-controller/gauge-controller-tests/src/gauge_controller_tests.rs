...
fn deploy() -> (
    ...
    let token: TestContract =
        GAUGECONLTROLLERInstance::new(&env, NAME, owner, Key::from(owner), Key::from(owner));
...
// #[test]
// fn test_gauge_controller_approve() {
...
// #[test]
// fn test_gauge_controller_transfer() {
...
// #[test]
// #[should_panic]
// fn test_gauge_controller_transfer_with_same_sender_and_recipient() {
//     let (env, token, owner, proxy, _proxy2) = deploy();
//     let package_hash = proxy.package_hash_result();
//     let user = env.next_user();
//     let amount: U256 = 100.into();
...
// #[test]
// fn test_gauge_controller_transfer_from() {
...
// #[test]
// #[should_panic]
// fn test_gauge_controller_transfer_from_too_much() {
//     let (env, token, owner, proxy, proxy2) = deploy();
//     let package_hash = proxy.package_hash_result();
//     let package_hash2 = proxy2.package_hash_result();
//     let user = env.next_user();
...
// #[test]
// fn test_gauge_controller_increase_allowance() {
...
// #[test]
// fn test_gauge_controller_decrease_allowance() {
//     let (_, token, owner, proxy, proxy2) = deploy();
//     let package_hash = proxy.package_hash_result();
//     let package_hash2 = proxy2.package_hash_result();
//     let amount: U256 = 100.into();
