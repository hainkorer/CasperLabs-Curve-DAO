...
use curve_token_v2::{self, CURVETOKENV2};
use erc20_crate::{self, ERC20};

#[derive(Default)]
struct CurveTokenV2(OnChainContractStorage);
impl ContractContext<OnChainContractStorage> for CurveTokenV2 {
    fn storage(&self) -> &OnChainContractStorage {
        &self.0
    }
}
impl ERC20<OnChainContractStorage> for CurveTokenV2 {}
impl CURVETOKENV2<OnChainContractStorage> for CurveTokenV2 {}
...
fn constructor() {
    ...
    CurveTokenV2::default().constructor(name, symbol, decimal, supply, contract_hash, package_hash);
}
#[no_mangle]
fn mint_crv2() {
...
fn set_minter() {
    ...
    CurveTokenV2::default().set_minter(_minter);
}
#[no_mangle]
fn burn_from() {
    let _to: Key = runtime::get_named_arg("_to");
    let _value: U256 = runtime::get_named_arg("_value");
    CurveTokenV2::default().burn_from(_to, _value);
}
#[no_mangle]
fn set_name() {
    let _name: String = runtime::get_named_arg("_name");
    let _symbol: String = runtime::get_named_arg("_symbol");
    CurveTokenV2::default().set_name(_name, _symbol);
}
