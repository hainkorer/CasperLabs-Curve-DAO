...
fn deploy_liquidity_gauge_reward(
    ...
    let cruve_rewards = deploy_curve_rewards(env, owner, token, reward,block_time);
    TestContract::new(
        env,
...
fn deploy() -> (TestEnv, AccountHash, TestContract,u64) {
    ...
    (env, owner, liquidity_gauge_reward_wrapper_instance,block_time)
}
...
fn test_claimable_tokens() {
    ...
    liquidity_gauge_reward_wrapper_instance.deposit(owner, U256::from(TEN_E_NINE * 1000), None,block_time);
    let addr: Key = Key::Account(owner);
    TestContract::new(
        &env,
        "liquidity-gauge-reward-wrapper-session-code.wasm",
...
fn test_withdraw() {
    ...
    let liquidity_gauge_reward_wrapper_instance =
        LIQUIDITYGAUGEREWARDWRAPPERInstance::contract_instance(instance);
    liquidity_gauge_reward_wrapper_instance.deposit(owner, U256::from(TEN_E_NINE * 1000), None,block_time);
    liquidity_gauge_reward_wrapper_instance.withdraw(owner, U256::from(TEN_E_NINE * 10), addr,block_time);
    TestContract::new(
        &env,
        TEST_SESSION_CODE_WASM,
        TEST_SESSION_CODE_NAME,
...
fn test_allowance() {
    ...
    let liquidity_gauge_reward_wrapper_instance =
        LIQUIDITYGAUGEREWARDWRAPPERInstance::contract_instance(instance);
    liquidity_gauge_reward_wrapper_instance.deposit(owner, U256::from(TEN_E_NINE * 1000), None,block_time);
    liquidity_gauge_reward_wrapper_instance.approve(owner, user_1, U256::from(TEN_E_NINE * 100),block_time);
    TestContract::new(
        &env,
        TEST_SESSION_CODE_WASM,
        TEST_SESSION_CODE_NAME,
...
fn test_transfer() {
    ...
    let liquidity_gauge_reward_wrapper_instance =
        LIQUIDITYGAUGEREWARDWRAPPERInstance::contract_instance(instance);
    liquidity_gauge_reward_wrapper_instance.deposit(owner, U256::from(TEN_E_NINE * 1000), None,block_time);
    liquidity_gauge_reward_wrapper_instance.transfer(owner, recipient, U256::from(TEN_E_NINE * 10),block_time);
    TestContract::new(
        &env,
        TEST_SESSION_CODE_WASM,
        TEST_SESSION_CODE_NAME,
