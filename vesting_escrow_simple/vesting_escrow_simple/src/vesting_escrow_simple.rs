...
impl VESTINGESCROWSIMPLE_EVENT {
    pub fn type_name(&self) -> String {
        match self {
            ...
            VESTINGESCROWSIMPLE_EVENT::CommitOwnership {
                admin: _,
            } => "commit_ownership",
            VESTINGESCROWSIMPLE_EVENT::ApplyOwnership {
                admin: _,
            } => "apply_ownership",
        }
        .to_string()
        ...
        ContractContext<Storage>
{
    ...
    fn _total_vested_of(&self,recipient:Key,time:U256)->U256 {   //deafault parameter time
    ...
    fn locked_supply(&self)->U256{
        ...
        initial_locked_supply.checked_sub(total_vested).unwrap_or_revert()
     ...
     fn balance_of(&self,recipient:Key)->U256{
        ...
        total_vested_of.checked_sub(self_total_claimed).unwrap_or_revert()
     ...
     fn locked_of(&self,recipient:Key)->U256 {
        ...
        let blocktime: u64 = runtime::get_blocktime().into();
        let total_vested_of:U256=self._total_vested_of(recipient,U256::from(blocktime));
        initial_locked.checked_sub(total_vested_of).unwrap_or_revert()       
     }
