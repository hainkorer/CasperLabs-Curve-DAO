...
impl ERC20CRVInstance {
    ...
    pub fn start_epoch_time_write(&self, sender: AccountHash) {
        self.0
            .call_contract(sender, "start_epoch_time_write", runtime_args! {});
    }
    pub fn start_epoch_time_write_js_client(&self, sender: AccountHash) {
        self.0
            .call_contract(sender, "start_epoch_time_write_js_client", runtime_args! {});
    }
    pub fn future_epoch_time_write(&self, sender: AccountHash) {
        self.0
            .call_contract(sender, "future_epoch_time_write", runtime_args! {});
    }
    ...
    pub fn available_supply(&self, sender: AccountHash) {
        self.0
            .call_contract(sender, "available_supply", runtime_args! {});
    }
    pub fn available_supply_js_client(&self, sender: AccountHash) {
        self.0
            .call_contract(sender, "available_supply_js_client", runtime_args! {});
    }
